...
🛠️ Bᴜɪʟᴅ Sᴛᴀᴛᴜs: <code> {VERSION}</code>
...
<b>╰➤ 🗣️ ᴄʜᴀᴛ ᴛʏᴘᴇ :</b> <code>{chat_title}</code>

<b>⚙️ ʙᴏᴛ ɴᴀᴍᴇ :</b> <code>{bot_name}</code>
...
"""
    ...
    WELCOME_TEMPLATE = """<b>✅ ᴠᴇʀɪғɪᴇᴅ ꜱᴜᴄᴄᴇꜱꜱғᴜʟʟʏ

👋 ᴡᴇʟᴄᴏᴍᴇ {ᴜꜱᴇʀ},  
ᴛᴏ <b>{ᴄʜᴀᴛ} 🎉

🕰️ <i>Jᴏɪɴᴇᴅ ᴏɴ: <ᴄᴏᴅᴇ>{ᴛɪᴍᴇꜱᴛᴀᴍᴘ}</i>
